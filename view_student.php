   ...
   <?php
    ...
    <div class="content">
        ...
        <table border="1px">
            ...
            <td class="table_td"> <?php echo "<a class='btn btn-danger' onClick=\"javascript:return confirm('Are you sure you to delete this student?');\" href='delete.php?student_id={$info['id']}'>Delete</a>"; ?> </td>
