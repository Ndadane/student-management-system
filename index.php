...
// Show a one-time flash message (e.g. after a successful admission
// submission), then clear it — without destroying the whole session.
$flash = null;
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <img class="teacher_img" src="<?php echo htmlspecialchars($info['image']); ?>" alt="Teacher_image"/>
